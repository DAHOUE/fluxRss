...
import 'package:iso_news_flux_rss/widgets/page_details.dart';
...
class _Liste extends State<Liste>{
  ...
  Widget build(BuildContext context) {
    ...
    return new ListView.builder(
      ...
      itemCount: widget.rssFeed.items.length - 10,
                  ...
                  Padding(
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[
                        ...
                        new TextAvecStyle((item.author != null ) ? item.author : 'indisponible'),
